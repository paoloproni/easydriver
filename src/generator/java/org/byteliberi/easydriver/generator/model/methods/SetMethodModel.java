...
/**
 * This class models a a setter method
 * @author Paolo Proni
 */
public class SetMethodModel extends MethodModel {
	 ...
	 */
	public SetMethodModel(final Visibility visibility, final String returnClass, 
	...
	public void write(final PrintStream out) {
		...
		sb.append('\t').append(visibility.getToken()).append(" final void ").append(methodName).append('(')
		  .append("final ").append(returnClass)
