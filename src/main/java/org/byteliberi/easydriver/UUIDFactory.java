...
/**
 * This class is used when a query result is a simple, scalar, UUID value
 * 
 * @author Paolo Proni
 * @since 1.0
 * @version 1.0
 */
public class UUIDFactory implements ObjectFactory<UUID> {
	/**
	 ...
	 */
	public UUIDFactory(final int index) {
		this.index = index;
	}

	@Override
	public UUID map(ResultSet rs) throws SQLException {
		return ( UUIDField.getEmpty() ).map(rs, this.index);		
	}
