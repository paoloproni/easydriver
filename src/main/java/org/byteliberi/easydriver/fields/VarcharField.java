/*
f * EasyDriver is a library that let a programmer build queries easier
...
/**
 * This is a table field that matches the VARCHAR database type.
 * 
 * @author Paolo Proni
 * @since 1.0
 * @version 1.0
 */
public class VarcharField extends TableField<String> {
	/**
	 * This instance is used when the caller needs the map methods only.
	 */
	private final static VarcharField empty = new VarcharField();
	
	/**
	 * Creates a new instance of this class.
	 */
	private VarcharField() {
		super();
	}
	 ...
	 */
	public static VarcharField getEmpty() {
		return empty;
	} 
	 ...
	 */
	public VarcharField(final String name, final DBTable<?> table) {
		super(name, table);
	}
	 ...
	 */
	public VarcharField(final String name, final boolean annullable, final DBTable<?> table) {
